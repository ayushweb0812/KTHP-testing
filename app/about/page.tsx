...
// About page has LineageWalk + LineageEntry which use useState/useEffect/useRef.
// Entire page is a Client Component to support these interactive sub-components.
